...
mod_name = "TagAlert"
help = """
  If you are tagged/mentioned in a group where Shasa is present
  Shasa will notify it to you via private message after enabling tag alerts
Commands
  • /tagalert on : Turn tag alerts on
  • /tagalert off : Turn tag alert off
Example:
If you are mentioned in a group Shasa will tell you who mentioned you, 
