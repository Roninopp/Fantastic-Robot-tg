...
# Replace TGN to your actual telegram bot module and import pyrogram client from it.
...
class STRINGS:
    ...
    SUPPORT_CHAT = '<b>Support Chat:</b> @Team_samurai_support'
    BOUNTY_RESULT = '''
<b>• Here is your Bounty!</b>

<b>UPDATES:</b> @FANTASTIC_UPDATES
    '''
