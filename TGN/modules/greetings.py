...
from TGN.modules.helper_funcs.chat_status import is_user_ban_protected, user_admin
from TGN.modules.helper_funcs.misc import build_keyboard, revert_buttons
from TGN.modules.helper_funcs.msg_types import get_welcome_type
from TGN.modules.helper_funcs.string_handling import (
...
ENUM_FUNC_MAP = {
    sql.Types.TEXT.value: TGN_PTB.bot.send_message,
    sql.Types.BUTTON_TEXT.value: TGN_PTB.bot.send_message,
    sql.Types.STICKER.value: TGN_PTB.bot.send_sticker,
    sql.Types.DOCUMENT.value: TGN_PTB.bot.send_document,
    sql.Types.PHOTO.value: TGN_PTB.bot.send_photo,
    sql.Types.AUDIO.value: TGN_PTB.bot.send_audio,
    sql.Types.VOICE.value: TGN_PTB.bot.send_voice,
    sql.Types.VIDEO.value: TGN_PTB.bot.send_video,
}
...
WELC_HELP_TXT = (
    ...
    "buttons.\n"
    f"To create a button linking to your rules, use this: `[Rules](buttonurl://t.me/{TGN_PTB.bot.username}?start=group_id)`. "
...
TGN_PTB.add_handler(NEW_MEM_HANDLER)
TGN_PTB.add_handler(LEFT_MEM_HANDLER)
TGN_PTB.add_handler(WELC_PREF_HANDLER)
TGN_PTB.add_handler(GOODBYE_PREF_HANDLER)
TGN_PTB.add_handler(SET_WELCOME)
TGN_PTB.add_handler(SET_GOODBYE)
TGN_PTB.add_handler(RESET_WELCOME)
TGN_PTB.add_handler(RESET_GOODBYE)
TGN_PTB.add_handler(CLEAN_WELCOME)
TGN_PTB.add_handler(WELCOME_HELP)
TGN_PTB.add_handler(WELCOMEMUTE_HANDLER)
TGN_PTB.add_handler(CLEAN_SERVICE_HANDLER)
TGN_PTB.add_handler(BUTTON_VERIFY_HANDLER)
TGN_PTB.add_handler(WELCOME_MUTE_HELP)
