...
import TGN.modules.sql.feds_sql as sql
from TGN import (
    EVENT_LOGS,
    LOGGER,
    SUPPORT_CHAT,
...
from TGN.modules.helper_funcs.extraction import (
    extract_unt_fedban,
    extract_user,
    extract_user_fban,
)
...
def fed_ban(update: Update, context: CallbackContext):
    ...
    if fban:
        fed_name = info["fname"]
        # https://t.me/OnePunchSupport/41606 // https://t.me/liu_wulang_monkes/41619
