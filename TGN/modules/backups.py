...
import TGN.modules.sql.notes_sql as sql
from TGN import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from TGN.__main__ import DATA_IMPORT
from TGN.modules.helper_funcs.chat_status import user_admin
from TGN.modules.helper_funcs.alternate import typing_action

# from TGN.modules.rules import get_rules
import TGN.modules.sql.rules_sql as rulessql

# from TGN.modules.sql import warns_sql as warnssql
import TGN.modules.sql.blacklist_sql as blacklistsql
from TGN.modules.sql import disable_sql as disabledsql

# from TGN.modules.sql import cust_filters_sql as filtersql
# import TGN.modules.sql.welcome_sql as welcsql
import TGN.modules.sql.locks_sql as locksql
from TGN.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("FANTASTICFIGHTERBOT{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("FANTASTICFIGHTERBOT{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Fantastic Fighter Bot` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
