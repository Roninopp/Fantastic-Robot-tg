...
import TGN.modules.fun_strings as fun
from TGN import DEMONS, DRAGONS, dispatcher
from TGN.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
...
GN_IMG= "https://te.legra.ph/file/210ae7181ba3d7b98d86a.jpg"
DECIDE_IMG= "https://te.legra.ph/file/210ae7181ba3d7b98d86a.jpg"
JUDGE_IMG= "https://te.legra.ph/file/210ae7181ba3d7b98d86a.jpg"
...
ASD_IMG= "https://te.legra.ph/file/6b6673e6cbaa08ebc9fdd.jpg"
@run_async
@typing_action
def asadali(update, context):
    ...
    reply = f"✪ ʜɪ ɪᴛ ɪs ᴍᴇ RONIN ᴀʟɪ FANTASTIC ᴏᴡɴᴇʀ\n────────────────────────\n✪ {escape_markdown(first_name)} ᴅᴏsᴛ 🥰 ʜᴏᴡ ᴀʀᴇ ʏᴏᴜ\n────────────────────────\n✪ ᴡᴀɴᴛ ᴛᴏ ᴋɴᴏᴡ ᴀʙᴏᴜᴛ ᴍᴇ ᴠɪsɪᴛ ᴛʜɪs [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/RONIN_FIGHTERS_FD) 🥰\n────────────────────────\n✪ ──『ᴛʜᴀɴᴋs  ғᴏʀ  ᴜsɪɴɢ』"
...
def slap(update: Update, context: CallbackContext):
    ...
    if update.effective_user.id == 2042185317:
        temp = "FANTASTIC OWNNER Slaps You Noob 😁 {user2}"
