...
def get_user_list(config, key):
    with open("{}/Emli/{}".format(os.getcwd(), config), "r") as json_file:
...
class Config(object):
    ...
    TOKEN = "21000962aGplsL0dn93S7nhAerxNPi6p77WKuudg"  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
